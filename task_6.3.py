...
class Position(Worker):
    ...
    def get_full_profit(self):
        self.__income = {'профит': self.profit, 'бонус': self.bonus}
        return self.__income

manager = Position('Петр ', 'Петров', 'менеджер', 500, 100)
